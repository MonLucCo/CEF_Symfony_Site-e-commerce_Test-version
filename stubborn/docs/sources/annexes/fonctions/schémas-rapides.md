...
## 3. Workflow de vérification de l’email
...
### 3.2. Cas d’échec (lien compromis ou expiré)
...
## 4. Architecture contrôleur → services → mailer
...
## 6. Séquence de validation du lien
...
## 7. Structure simplifiée de la base de données
...
## 9. Environnement Windows / WSL : structure et fonctionnement
...
## 9.3. Problème classique : localhost ≠ localhost

### 9.3.1. Localhost dans WSL
...
### 9.3.3. Accéder au serveur WSL depuis Windows
...
## 9.4. Fonctionnement réseau : schéma simplifié
...
## 9.5. Outils utilisés et où ils tournent
...
## 9.6. Implications pour le développement
